...
export const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: "Chaque type de contenu a une source unique de vérité, pour éviter les doublons : le README d'un dépôt présente le projet ; ce Manuel explique l'usage de la console elle-même ; le Wiki (organisation/équipe/projet, panneau « Documentation » d'une fiche) porte les connaissances dynamiques (procédures, notes d'équipe) ; Docusaurus (panneau « Documentation & Design System ») porte la documentation technique versionnée d'un projet ; Storybook (même panneau) documente les composants d'interface ; les ADR (panneau « Décisions techniques ») tracent les décisions d'architecture avec leur justification ; le Changelog d'un composant (Catalogue logiciel → releases) trace ses publications." }
    ]
  },
  {
