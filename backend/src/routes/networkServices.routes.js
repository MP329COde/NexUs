...
// branchée aujourd'hui). Ouvert en lecture/écriture à tout utilisateur
// authentifié, cohérent avec le reste de la gestion opérationnelle non
// critique (tâches, raccourcis, volumes).
const router = Router();
