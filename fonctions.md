...
- **OrganizationsPage.jsx** — Organisations (socle PostgreSQL). Bug corrigé : le `pattern` HTML du champ Identifiant cassait la validation native dans Chrome récent (mode unicode-sets — tiret final non échappé dans une classe de caractères).
